...
--Création de 2 colonnes "id" et "languages". Pour la première avec un type INT et une clé primaire et une auto incrémentation
(
  `id` INT PRIMARY KEY NOT NULL AUTO_INCREMENT,
  --Création d'un type VARCHAR avec le nombre de caractère entre parenthèse (chaîne de caractères)
